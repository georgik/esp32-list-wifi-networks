...
fn main() {
    // Set the Slint include path
    println!("cargo:rustc-env=SLINT_INCLUDE_GENERATED=src/ui/generated");

    // Generate the Slint UI code from our .slint file
    slint_build::compile("ui/wifi_list.slint").unwrap();
